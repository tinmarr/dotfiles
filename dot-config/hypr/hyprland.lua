...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("app2unit -u qs.service -t service -s a -- qs")
end)
...
local function reload()
    ...
    hl.exec_cmd("systemctl --user stop qs; app2unit -u qs.service -t service -s a -- qs")
end
...
hl.define_submap("open", "reset", function()
    hl.bind("a", hl.dsp.exec_cmd("ghostty +new-window --title='-float-' -e wiremix"))
    hl.bind("b", hl.dsp.exec_cmd("ghostty +new-window --title='-float-' -e bluetui"))
    hl.bind("w", hl.dsp.exec_cmd("ghostty +new-window --title='-float-' -e impala"))
